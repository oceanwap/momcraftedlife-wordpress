...
/**
 * Title: Search
 * Slug: kids-learning-toys/search
 * Categories: kids-learning-toys, search
 */
?>

<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() . '/images/inner-banner.jpg'); ?>","id":6,"dimRatio":50,"isUserOverlayColor":true,"minHeight":300,"align":"full","className":"inner-cover-img","layout":{"type":"constrained","contentSize":"90%"}} -->
