...
/**
 * Title: Page Title
 * Slug: kids-learning-toys/page-title
 * Categories: kids-learning-toys, page-title
 */
?>

<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() . '/images/inner-banner.jpg'); ?>","id":6,"dimRatio":50,"minHeight":300,"className":"inner-cover-img","layout":{"type":"constrained","contentSize":"90%"}} -->
